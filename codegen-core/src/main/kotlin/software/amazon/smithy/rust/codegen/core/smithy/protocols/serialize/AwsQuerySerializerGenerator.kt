...
class AwsQuerySerializerGenerator(codegenContext: CodegenContext, private val httpBindingResolver: HttpBindingResolver,) : QuerySerializerGenerator(codegenContext) {
    ...
    override fun operationOutputSerializer(operationShape: OperationShape): RuntimeType? {
        ...
        val prefix = operationXmlName.replace("Response", "Result")
                ...
                *codegenScope, "target" to symbolProvider.toSymbol(outputShape),
                ...
                rustBlock("") {
                    rustTemplate(
                        ...
                        let root = root.start_el(${prefix.dq()});
                        """,
                        *codegenScope,
                    )
